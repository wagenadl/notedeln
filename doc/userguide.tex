...
made unconditionally as you type (Figure 1).
%
\begin{figure}
...
\caption{{\bf Unconditional character substitutions.} To get the glyph on the left, type the character
  ...
  equals signs. {\bf e.}~Other mathematical operators.}
\end{figure}
%
...
over the preceding character rather than as a separate entity.)}
\end{figure}
%
